...
var BuildId = "fLvsB59AjfNUWIAPkD8jn";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/customers/route": "/api/customers", "/api/customer-check/route": "/api/customer-check", "/api/contact/route": "/api/contact", "/api/flex-ai-chat/route": "/api/flex-ai-chat", "/api/login/route": "/api/login", "/api/hero-products/route": "/api/hero-products", "/api/logistics-costs/route": "/api/logistics-costs", "/api/nlp-classify/route": "/api/nlp-classify", "/api/order-lookup/route": "/api/order-lookup", "/api/orders/[id]/route": "/api/orders/[id]", "/api/orders/route": "/api/orders", "/api/pixel/route": "/api/pixel", "/api/products/[slug]/route": "/api/products/[slug]", "/api/reviews/route": "/api/reviews", "/api/products/route": "/api/products", "/api/settings/route": "/api/settings", "/api/stats/route": "/api/stats", "/api/stock-remaining/route": "/api/stock-remaining", "/favicon.ico/route": "/favicon.ico", "/robots.txt/route": "/robots.txt", "/sitemap.xml/route": "/sitemap.xml", "/api/upload/route": "/api/upload", "/checkout/page": "/checkout", "/order-success/page": "/order-success", "/products/page": "/products", "/reviews/write/page": "/reviews/write", "/about/page": "/about", "/contact/page": "/contact", "/delivery/page": "/delivery", "/products/[slug]/page": "/products/[slug]", "/reviews/page": "/reviews", "/size-guide/page": "/size-guide", "/page": "/", "/admin/customers/page": "/admin/customers", "/admin/login/page": "/admin/login", "/admin/finance/page": "/admin/finance", "/admin/orders/page": "/admin/orders", "/admin/products/page": "/admin/products", "/admin/logistics/page": "/admin/logistics", "/admin/products/[id]/page": "/admin/products/[id]", "/admin/reviews/page": "/admin/reviews", "/admin/settings/page": "/admin/settings", "/admin/stock/page": "/admin/stock", "/flex-ai/page": "/flex-ai", "/admin/dashboard/page": "/admin/dashboard" };
