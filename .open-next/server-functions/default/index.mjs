...
var BuildId = "UF19NcDO2u5KOLyueV_e-";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/customers/route": "/api/customers", "/api/contact/route": "/api/contact", "/api/hero-products/route": "/api/hero-products", "/api/customer-check/route": "/api/customer-check", "/api/nlp-classify/route": "/api/nlp-classify", "/api/login/route": "/api/login", "/api/logistics-costs/route": "/api/logistics-costs", "/api/order-lookup/route": "/api/order-lookup", "/api/flex-ai-chat/route": "/api/flex-ai-chat", "/api/orders/[id]/route": "/api/orders/[id]", "/api/orders/route": "/api/orders", "/api/pixel/route": "/api/pixel", "/api/products/[slug]/route": "/api/products/[slug]", "/api/settings/route": "/api/settings", "/api/stats/route": "/api/stats", "/api/reviews/route": "/api/reviews", "/api/stock-remaining/route": "/api/stock-remaining", "/api/products/route": "/api/products", "/robots.txt/route": "/robots.txt", "/favicon.ico/route": "/favicon.ico", "/sitemap.xml/route": "/sitemap.xml", "/api/upload/route": "/api/upload", "/checkout/page": "/checkout", "/products/page": "/products", "/reviews/write/page": "/reviews/write", "/order-success/page": "/order-success", "/about/page": "/about", "/contact/page": "/contact", "/delivery/page": "/delivery", "/products/[slug]/page": "/products/[slug]", "/reviews/page": "/reviews", "/size-guide/page": "/size-guide", "/page": "/", "/admin/customers/page": "/admin/customers", "/admin/login/page": "/admin/login", "/admin/finance/page": "/admin/finance", "/admin/logistics/page": "/admin/logistics", "/admin/products/[id]/page": "/admin/products/[id]", "/admin/products/page": "/admin/products", "/admin/orders/page": "/admin/orders", "/admin/reviews/page": "/admin/reviews", "/admin/stock/page": "/admin/stock", "/admin/settings/page": "/admin/settings", "/flex-ai/page": "/flex-ai", "/admin/dashboard/page": "/admin/dashboard" };
