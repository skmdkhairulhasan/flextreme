...
var BuildId = "XwDT4Jl9uI5w8An5Jgctu";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/customer-check/route": "/api/customer-check", "/api/contact/route": "/api/contact", "/api/customers/route": "/api/customers", "/api/hero-products/route": "/api/hero-products", "/api/flex-ai-chat/route": "/api/flex-ai-chat", "/api/login/route": "/api/login", "/api/logistics-costs/route": "/api/logistics-costs", "/api/nlp-classify/route": "/api/nlp-classify", "/api/order-lookup/route": "/api/order-lookup", "/api/orders/[id]/route": "/api/orders/[id]", "/api/orders/route": "/api/orders", "/api/pixel/route": "/api/pixel", "/api/products/[slug]/route": "/api/products/[slug]", "/api/products/route": "/api/products", "/api/settings/route": "/api/settings", "/api/reviews/route": "/api/reviews", "/api/stats/route": "/api/stats", "/api/stock-remaining/route": "/api/stock-remaining", "/robots.txt/route": "/robots.txt", "/favicon.ico/route": "/favicon.ico", "/sitemap.xml/route": "/sitemap.xml", "/api/upload/route": "/api/upload", "/checkout/page": "/checkout", "/order-success/page": "/order-success", "/products/page": "/products", "/reviews/write/page": "/reviews/write", "/about/page": "/about", "/contact/page": "/contact", "/delivery/page": "/delivery", "/products/[slug]/page": "/products/[slug]", "/reviews/page": "/reviews", "/size-guide/page": "/size-guide", "/page": "/", "/admin/customers/page": "/admin/customers", "/admin/login/page": "/admin/login", "/admin/logistics/page": "/admin/logistics", "/admin/orders/page": "/admin/orders", "/admin/finance/page": "/admin/finance", "/admin/products/[id]/page": "/admin/products/[id]", "/admin/products/page": "/admin/products", "/admin/reviews/page": "/admin/reviews", "/admin/stock/page": "/admin/stock", "/admin/settings/page": "/admin/settings", "/flex-ai/page": "/flex-ai", "/admin/dashboard/page": "/admin/dashboard" };
