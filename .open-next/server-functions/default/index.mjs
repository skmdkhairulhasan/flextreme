...
var BuildId = "JafDy55qkdafQEuW3TEDR";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/contact/route": "/api/contact", "/api/customers/route": "/api/customers", "/api/customer-check/route": "/api/customer-check", "/api/nlp-classify/route": "/api/nlp-classify", "/api/order-lookup/route": "/api/order-lookup", "/api/flex-ai-chat/route": "/api/flex-ai-chat", "/api/login/route": "/api/login", "/api/hero-products/route": "/api/hero-products", "/api/orders/[id]/route": "/api/orders/[id]", "/api/logistics-costs/route": "/api/logistics-costs", "/api/reviews/route": "/api/reviews", "/api/pixel/route": "/api/pixel", "/api/products/[slug]/route": "/api/products/[slug]", "/api/products/route": "/api/products", "/api/stats/route": "/api/stats", "/api/settings/route": "/api/settings", "/api/stock-remaining/route": "/api/stock-remaining", "/api/orders/route": "/api/orders", "/robots.txt/route": "/robots.txt", "/favicon.ico/route": "/favicon.ico", "/sitemap.xml/route": "/sitemap.xml", "/api/upload/route": "/api/upload", "/checkout/page": "/checkout", "/order-success/page": "/order-success", "/products/page": "/products", "/reviews/write/page": "/reviews/write", "/about/page": "/about", "/contact/page": "/contact", "/delivery/page": "/delivery", "/products/[slug]/page": "/products/[slug]", "/size-guide/page": "/size-guide", "/reviews/page": "/reviews", "/page": "/", "/admin/customers/page": "/admin/customers", "/admin/logistics/page": "/admin/logistics", "/admin/login/page": "/admin/login", "/admin/finance/page": "/admin/finance", "/admin/products/page": "/admin/products", "/admin/orders/page": "/admin/orders", "/admin/products/[id]/page": "/admin/products/[id]", "/admin/reviews/page": "/admin/reviews", "/admin/stock/page": "/admin/stock", "/admin/settings/page": "/admin/settings", "/flex-ai/page": "/flex-ai", "/admin/dashboard/page": "/admin/dashboard" };
