...
var BuildId = "YpL7myLGnW7jbx4vtSi5U";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/contact/route": "/api/contact", "/api/customer-check/route": "/api/customer-check", "/api/flex-ai-chat/route": "/api/flex-ai-chat", "/api/customers/route": "/api/customers", "/api/hero-products/route": "/api/hero-products", "/api/login/route": "/api/login", "/api/nlp-classify/route": "/api/nlp-classify", "/api/logistics-costs/route": "/api/logistics-costs", "/api/order-lookup/route": "/api/order-lookup", "/api/orders/[id]/route": "/api/orders/[id]", "/api/orders/route": "/api/orders", "/api/pixel/route": "/api/pixel", "/api/products/[slug]/route": "/api/products/[slug]", "/api/products/route": "/api/products", "/api/settings/route": "/api/settings", "/api/reviews/route": "/api/reviews", "/api/stats/route": "/api/stats", "/api/stock-remaining/route": "/api/stock-remaining", "/favicon.ico/route": "/favicon.ico", "/sitemap.xml/route": "/sitemap.xml", "/robots.txt/route": "/robots.txt", "/api/upload/route": "/api/upload", "/checkout/page": "/checkout", "/order-success/page": "/order-success", "/products/page": "/products", "/reviews/write/page": "/reviews/write", "/about/page": "/about", "/contact/page": "/contact", "/delivery/page": "/delivery", "/products/[slug]/page": "/products/[slug]", "/size-guide/page": "/size-guide", "/reviews/page": "/reviews", "/page": "/", "/admin/logistics/page": "/admin/logistics", "/admin/finance/page": "/admin/finance", "/admin/customers/page": "/admin/customers", "/admin/orders/page": "/admin/orders", "/admin/login/page": "/admin/login", "/admin/reviews/page": "/admin/reviews", "/admin/stock/page": "/admin/stock", "/admin/products/page": "/admin/products", "/admin/settings/page": "/admin/settings", "/admin/products/[id]/page": "/admin/products/[id]", "/flex-ai/page": "/flex-ai", "/admin/dashboard/page": "/admin/dashboard" };
