...
var BuildId = "2gT7JDEMAlz-cH_Klec5U";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/contact/route": "/api/contact", "/api/customers/route": "/api/customers", "/api/customer-check/route": "/api/customer-check", "/api/flex-ai-chat/route": "/api/flex-ai-chat", "/api/hero-products/route": "/api/hero-products", "/api/login/route": "/api/login", "/api/nlp-classify/route": "/api/nlp-classify", "/api/orders/[id]/route": "/api/orders/[id]", "/api/orders/route": "/api/orders", "/api/order-lookup/route": "/api/order-lookup", "/api/logistics-costs/route": "/api/logistics-costs", "/api/pixel/route": "/api/pixel", "/api/products/[slug]/route": "/api/products/[slug]", "/api/products/route": "/api/products", "/api/reviews/route": "/api/reviews", "/api/settings/route": "/api/settings", "/api/stats/route": "/api/stats", "/api/stock-remaining/route": "/api/stock-remaining", "/robots.txt/route": "/robots.txt", "/favicon.ico/route": "/favicon.ico", "/sitemap.xml/route": "/sitemap.xml", "/api/upload/route": "/api/upload", "/checkout/page": "/checkout", "/order-success/page": "/order-success", "/products/[slug]/page": "/products/[slug]", "/products/page": "/products", "/reviews/write/page": "/reviews/write", "/about/page": "/about", "/contact/page": "/contact", "/delivery/page": "/delivery", "/reviews/page": "/reviews", "/size-guide/page": "/size-guide", "/page": "/", "/admin/customers/page": "/admin/customers", "/admin/finance/page": "/admin/finance", "/admin/login/page": "/admin/login", "/admin/logistics/page": "/admin/logistics", "/admin/products/[id]/page": "/admin/products/[id]", "/admin/products/page": "/admin/products", "/admin/reviews/page": "/admin/reviews", "/admin/settings/page": "/admin/settings", "/admin/stock/page": "/admin/stock", "/admin/orders/page": "/admin/orders", "/flex-ai/page": "/flex-ai", "/admin/dashboard/page": "/admin/dashboard" };
