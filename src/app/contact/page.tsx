        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "3rem", alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              {/* WhatsApp */}
              <a href={"https://wa.me/" + whatsapp} target="_blank" rel="noreferrer" style={{ display: "flex", gap: "1rem", alignItems: "flex-start", textDecoration: "none", color: "inherit", padding: "1.25rem", border: "1px solid #e0e0e0", transition: "border-color 0.2s" }}>
                ...
                <div>
                  <p style={{ fontWeight: 700, fontSize: "0.9rem", marginBottom: "0.2rem" }}>WhatsApp</p>
                  <p style={{ fontSize: "0.82rem", color: "#555" }}>+{whatsapp}</p>
                  <p style={{ fontSize: "0.72rem", color: "#16a34a", marginTop: "0.2rem", fontWeight: 600 }}>Available 9am – 9pm daily</p>
                </div>
              </a>
              ...
              {email && (
                <a href={"mailto:" + email} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", textDecoration: "none", color: "inherit", padding: "1.25rem", border: "1px solid #e0e0e0" }}>
                  ...
                  <div>
                    <p style={{ fontWeight: 700, fontSize: "0.9rem", marginBottom: "0.2rem" }}>Email</p>
                    <p style={{ fontSize: "0.82rem", color: "#555" }}>{email}</p>
                    <p style={{ fontSize: "0.72rem", color: "#999", marginTop: "0.2rem" }}>We reply within 24 hours</p>
                  </div>
                </a>
              )}
              ...
              {phone && (
                <a href={"tel:" + phone} style={{ display: "flex", gap: "1rem", alignItems: "flex-start", textDecoration: "none", color: "inherit", padding: "1.25rem", border: "1px solid #e0e0e0" }}>
                  ...
                  <div>
                    <p style={{ fontWeight: 700, fontSize: "0.9rem", marginBottom: "0.2rem" }}>Phone</p>
              ...
              {address && (
                <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start", padding: "1.25rem", border: "1px solid #e0e0e0" }}>
                  ...
                  <div>
                    <p style={{ fontWeight: 700, fontSize: "0.9rem", marginBottom: "0.2rem" }}>Address</p>
