...
export default function LogisticsPage() {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: "0", borderBottom: "2px solid black", marginBottom: "1.25rem", overflowX: "auto", touchAction: "pan-x" as any, overscrollBehaviorX: "contain" as any, WebkitOverflowScrolling: "touch" as any, }}>
        {[
