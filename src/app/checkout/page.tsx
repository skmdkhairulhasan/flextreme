      ...
      <div style={{ paddingTop: "72px", minHeight: "100vh", backgroundColor: "white" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto", padding: "4rem 1.5rem", textAlign: "center" }}>
          ...
          <div style={{ backgroundColor: "#f5f5f5", padding: "1.5rem", marginBottom: "2rem", textAlign: "left" }}>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", gap: "0.75rem", alignItems: "flex-start", marginBottom: "0.6rem" }}>
                <span style={{ width: "20px", height: "20px", borderRadius: "50%", backgroundColor: "black", color: "white", fontSize: "0.65rem", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "0.1rem" }}>{i + 1}</span>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <Link href="/products" style={{ display: "inline-block", backgroundColor: "black", color: "white", padding: "0.875rem 2rem", fontWeight: 700, fontSize: "0.8rem", textTransform: "uppercase", textDecoration: "none" }}>
              Continue Shopping
            </Link>
          </div>
        </div>
    ...
    return (
      <div style={{ paddingTop: "72px", minHeight: "100vh", backgroundColor: "white" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto", padding: "4rem 1.5rem", textAlign: "center" }}>
          ...
          <Link href="/products" style={{ display: "inline-block", backgroundColor: "black", color: "white", padding: "0.875rem 2rem", fontWeight: 700, fontSize: "0.875rem", textTransform: "uppercase", textDecoration: "none", letterSpacing: "0.1em" }}>
            Browse Products
          </Link>
        </div>
      </div>
